# StudyHub Online Education Platform (MERN App)
...
The StudyNotion is an ed-tech platform which consists of three main components: the front end, the
...
The front end communicates with the back end using RESTful API calls created using Express for server and node as back end.
