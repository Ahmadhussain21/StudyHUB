    ...
    <div className='mt-[130px] mb-32'>
      <div className='flex flex-col gap-5 items-center'>
        ...
        <div className='flex flex-row items-center justify-center mt-5'>
          <img src={knowYourProgress} alt="Progress Image" className='object-contain -mr-32' />
          <img src={compareWithOthers} alt="Compare Image" className='object-contain ' />
          <img src={planYourLessons} alt="Plan Image" className='object-contain -ml-36' />
        </div>
        <div className='w-fit'>
